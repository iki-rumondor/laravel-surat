...
Route::group(['middleware' => 'auth:pengguna'], function(){
    ...
    Route::group(['prefix' => 'disposisi'], function() {
        ...
        Route::get('create', [
            'uses' => 'DisposisiController@create',
            'as' => 'disposisi.create'
        ]);
        Route::get('{id}', [
            'uses' => 'DisposisiController@edit',
            'as' => 'disposisi.edit'
        ]);
        Route::post('', [
            'uses' => 'DisposisiController@store',
            'as' => 'disposisi.store'
        ]);
        Route::post('{id}', [
            'uses' => 'DisposisiController@update',
            'as' => 'disposisi.update'
        ]);
        Route::post('{id}', [
            'uses' => 'DisposisiController@delete',
            'as' => 'disposisi.delete'
        ]);
    });
    Route::group([
    ...
    Route::group(['prefix' => 'fetches'], function(){
        Route::get('surat_masuk/{id}', [
            'uses' => 'FetchController@get_surat_masuk',
        ]);
    });

    Route::group(['prefix' => 'print'], function(){
        Route::get('disposisi/{id}', [
            'uses' => 'PrintController@disposisi',
        ]);
    });
});
